 ...
 *
 */
public class AlmNightReceiver extends BroadcastReceiver {
	private static final String TAG = "AlmNightReceiver";
	...
	static Intent[] makeMessageIntentStack(Context context) {
        ...
        intents[0].putExtra("period", "night");
	...
	public void onReceive(Context context, Intent intent) {
        ...
        // get information
        String contentTitle = context.getString(R.string.notif_night_content_title);
        String contentText  = context.getString(R.string.notif_night_content_text);
