 ...
 *
 */
public class AlmMorReceiver extends BroadcastReceiver {
	private static final String TAG = "AlmMorReceiver";
	...
	static Intent[] makeMessageIntentStack(Context context) {
        ...
        intents[0].putExtra("period", "morning");
	...
	public void onReceive(Context context, Intent intent) {
        ...
        // get information
        String contentTitle = context.getString(R.string.notif_morning_content_title);
        String contentText  = context.getString(R.string.notif_morning_content_text);
