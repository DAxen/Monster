 ...
 *
 */
public class AlmNoonReceiver extends BroadcastReceiver {
	private static final String TAG = "AlmNoonReceiver";
	...
	static Intent[] makeMessageIntentStack(Context context) {
        ...
        intents[0].putExtra("period", "noon");
	...
	public void onReceive(Context context, Intent intent) {
        ...
        // get information
        String contentTitle = context.getString(R.string.notif_noon_content_title);
        String contentText  = context.getString(R.string.notif_noon_content_text);
